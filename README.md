...
<img src="https://raw.githubusercontent.com/Hit-Paw/HitPaw-MangaDex-Manager/main/docs/public/icon_256.png" width="140" alt="Logo">

# **Hit-Paw**

**Developer · Builder · Privacy-first**
...
#### [HitPaw MangaDex Manager](https://github.com/Hit-Paw/HitPaw-MangaDex-Manager)
> Cross-platform desktop app for browsing, filtering, and exporting your MangaDex library — fully offline.

**Supported imports:** MyAnimeList · AniList · Kitsu · MangaFire · Anime-Planet · MangaBaka

[![Release](https://img.shields.io/github/v/release/Hit-Paw/HitPaw-MangaDex-Manager?color=ff6a00&label=Latest%20Release)](https://github.com/Hit-Paw/HitPaw-MangaDex-Manager/releases)
[![License](https://img.shields.io/github/license/Hit-Paw/HitPaw-MangaDex-Manager?color=blue)](https://github.com/Hit-Paw/HitPaw-MangaDex-Manager/blob/main/LICENSE)
[![Downloads](https://img.shields.io/github/downloads/Hit-Paw/HitPaw-MangaDex-Manager/total?color=green&label=Downloads)](https://github.com/Hit-Paw/HitPaw-MangaDex-Manager/releases)

</td>
<td width="50%">

**Key Features**
- &#x1f5a5; Cover grid with fast search
- &#x1f4e4; Export to CSV, JSON, MAL XML, Anime-Planet, MangaBaka
- &#x1f512; 100% local — credentials never leave your machine
- &#x1f31f; Dark AMOLED UI with smooth scrolling
- &#x2699; Windows · macOS · Linux — no installer needed
